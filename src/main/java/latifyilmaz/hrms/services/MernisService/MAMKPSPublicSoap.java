...
public class MAMKPSPublicSoap
{
    ...
    public MAMKPSPublicSoap(){}

    public MAMKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public MAMKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MAMExtendedSoapSerializationEnvelope envelope= new MAMExtendedSoapSerializationEnvelope(MAMExtendedSoapSerializationEnvelope.VER11);
