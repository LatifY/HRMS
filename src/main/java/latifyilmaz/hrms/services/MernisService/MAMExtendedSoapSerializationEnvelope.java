...
public class MAMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(MAMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MAMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MAMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MAMDateTimeConverter dateTimeConverter = new MAMStandardDateTimeConverter();

    public MAMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MAMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MAMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MAMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MAMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MAMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
