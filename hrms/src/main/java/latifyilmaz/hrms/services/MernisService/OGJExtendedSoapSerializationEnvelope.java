...
public class OGJExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(OGJDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new OGJStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static OGJDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OGJDateTimeConverter dateTimeConverter = new OGJStandardDateTimeConverter();

    public OGJExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OGJExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OGJMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=OGJHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OGJExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=OGJHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
