...
public class OGJKPSPublicSoap
{
    ...
    public OGJKPSPublicSoap(){}

    public OGJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public OGJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        OGJExtendedSoapSerializationEnvelope envelope= new OGJExtendedSoapSerializationEnvelope(OGJExtendedSoapSerializationEnvelope.VER11);
